...
export default function PayslipPage() {
  ...
  const withLivePayment = Math.floor(withLiveIncome * 0.5);
        ...
        <div className="transform origin-top transition-transform scale-[0.42] h-[125mm] sm:scale-75 sm:h-[223mm] md:scale-100 md:h-auto xl:scale-100 xl:h-auto">
            ...
            <div className="mb-8">
                ...
                <thead>
                    ...
                    <th className="border border-gray-800 p-2 w-1/2" style={{ backgroundColor: '#e0f2fe', color: '#000000', fontWeight: 'bold' }}>支給項目</th>
                    <th className="border border-gray-800 p-2 w-1/2" style={{ backgroundColor: '#e0f2fe', color: '#000000', fontWeight: 'bold' }}>金額 (円)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                    <td className="border border-gray-800 p-2 text-black">オフ会</td>
                    <td className="border border-gray-800 p-2 text-right text-black font-mono text-base">{Number(formData.offMeeting).toLocaleString()}</td>
                    </tr>
                    <tr>
                    <td className="border border-gray-800 p-2 text-black">チェキ</td>
                    <td className="border border-gray-800 p-2 text-right text-black font-mono text-base">{Number(formData.cheki).toLocaleString()}</td>
                    </tr>
                    <tr>
                    <td className="border border-gray-800 p-2 text-black">SHOWROOMギャランティ</td>
                    <td className="border border-gray-800 p-2 text-right text-black font-mono text-base">{Number(formData.showroom).toLocaleString()}</td>
                    </tr>
                    <tr>
                    <td className="border border-gray-800 p-2 text-black">グッズ支給額</td>
                    <td className="border border-gray-800 p-2 text-right text-black font-mono text-base">{Number(formData.goods).toLocaleString()}</td>
                    </tr>
            ...
            <div className="mb-8">
                ...
                <tbody>
                    <tr>
                    <td className="border border-gray-800 p-2 text-black">源泉所得税 <span className="text-xs text-gray-700 font-medium ml-2">(10.21%)</span></td>
